...
- Backend (clojure -M -m hello.core): proceso que quieres controlar tú; idealmente con un REPL conectado para recarga en caliente.
...
**Frontend**: editas frontend/src/hello/app.cljs → shadow recompila solo → recargas el navegador.
